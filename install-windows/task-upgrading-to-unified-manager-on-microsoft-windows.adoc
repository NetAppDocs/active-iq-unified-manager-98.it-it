...
sidebar: sidebar 
keywords:  
summary: È possibile aggiornare Unified Manager 9.6 o 9.7 a 9.8 scaricando ed eseguendo il file di installazione sulla piattaforma Windows. 
---
...
[role="lead"]
È possibile aggiornare Unified Manager 9.6 o 9.7 a 9.8 scaricando ed eseguendo il file di installazione sulla piattaforma Windows.
