...
[NOTE]
====
Le porte utilizzate per le comunicazioni HTTP e HTTPS (porte 80 e 443) possono essere modificate utilizzando la console di manutenzione di Unified Manager. Per ulteriori informazioni, consulta _Configurazione di Active IQ Unified Manager_.

====
link:../config/concept-configuring-unified-manager.html["Configurazione di Active IQ Unified Manager"]
